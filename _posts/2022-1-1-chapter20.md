...
<audio controls><source src='https://raw.githubusercontent.com/PTAccess/PTAccess.github.io/master/audio/235 Right-clicking an I/O path selector.m4a'></audio>
...
<audio controls><source src='https://raw.githubusercontent.com/PTAccess/PTAccess.github.io/master/audio/236 Using Modifiers While Assigning I/O Paths.m4a'></audio>
...
Mix groups can be configured to affect the following track parameters, depending on the software version (Pro Tools Standard or Pro Tools | Ultimate) and the selected group attributes:
...
Mix groups do not affect the following parameters in Pro Tools Standard (Pro Tools | Ultimate provides additional attribute settings for each of these options):
